...
decodeFunctionResult(functionFragment: 'withdraw', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    addMeterType: TypedContractMethod<
      [name: string, description: string, maxValue: BigNumberish, minValue: BigNumberish, active: boolean, ],
      [void],
      'nonpayable'
    >
    ...
    getMeterInfo: TypedContractMethod<
      [meterId: AddressLike, ],
      [[string, string, string, bigint, boolean, boolean] & {meterType: string, location: string, meterOwner: string, registrationTime: bigint, meterIsActive: boolean, meterIsSuspended: boolean }],
      'view'
    >
    ...
    getMeterType: TypedContractMethod<
      [name: string, ],
      [[string, bigint, bigint, boolean] & {description: string, maxValue: bigint, minValue: bigint, active: boolean }],
      'view'
    >
    ...
    meterTypes: TypedContractMethod<
      [arg0: string, ],
      [[string, string, bigint, bigint, boolean] & {name: string, description: string, maxValue: bigint, minValue: bigint, isActiveType: boolean }],
      'view'
    >
    ...
    meters: TypedContractMethod<
      [arg0: AddressLike, ],
      [[string, string, string, string, bigint, boolean, boolean, string, string, bigint, bigint] & {meterId: string, meterType: string, location: string, meterOwner: string, registrationTime: bigint, isActiveMeter: boolean, isSuspended: boolean, suspensionReason: string, suspendedBy: string, suspensionTime: bigint, authorizedUserCount: bigint }],
      'view'
    >
